            ...
            <p class="flex flex-col gap-2">
                ...
                <select name="id_orang" id="id_orang" required>
                    ...
                    <?php while ($row = mysqli_fetch_assoc($result_orang)) { ?>
                        <option value="<?php echo $row['id']; ?>" <?php if ($id_orang == $row['id']) { echo 'selected'; } ?>><?php echo $row['nama']; ?></option>
                    <?php } ?>
                </select>
            </p>
            <p class="flex flex-col gap-2">
                ...
                <select name="id_hewan" id="id_hewan" required>
                    ...
                    <?php while ($row = mysqli_fetch_assoc($result_hewan)) { ?>
                        <option value="<?php echo $row['id']; ?>" <?php if ($id_hewan == $row['id']) { echo 'selected'; } ?>><?php echo $row['nama']; ?></option>
                    <?php } ?>
                </select>
            </p>
            <p class="flex flex-col gap-2">
                ...
                <select name="id_warna" id="id_warna" required>
                    ...
                    <?php while ($row = mysqli_fetch_assoc($result_warna)) { ?>
                        <option value="<?php echo $row['id']; ?>" <?php if ($id_warna == $row['id']) { echo 'selected'; } ?>><?php echo $row['nama']; ?></option>
                    <?php } ?>
                </select>
            </p>
        </fieldset>
